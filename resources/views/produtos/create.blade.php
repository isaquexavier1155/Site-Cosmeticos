    ...
    <div class="container mt-5">
        ...
        <form action="{{ route('produtos.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <textarea placeholder="Digite um item e pressione enter" name="caracteristicas" id="caracteristicas"
                    class="form-control" rows="3">{{ old('caracteristicas') }}</textarea>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="preco_promocional" id="preco_promocional" class="form-control" step="0.01"
                    required>
            ...
            <div class="mb-3">
                ...
                <select id="categoria" name="categoria" class="form-select" required>
                    ...
                    <option value="Body splash" {{ old('categoria') == 'Body splash' ? 'selected' : '' }}>Body splash
                    </option>
                    <option value="Hidratantes" {{ old('categoria') == 'Hidratantes' ? 'selected' : '' }}>Hidratantes
                    </option>
                </select>
                @error('categoria')
                    <div class="text-danger">{{ $message }}</div>
